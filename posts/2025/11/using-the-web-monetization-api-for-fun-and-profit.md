...
> Web Monetization gives publishers more revenue options and audiences more ways
...
I encourage you all to give it a try! Install the
[extension](https://chromewebstore.google.com/detail/web-monetization/oiabcfomehhigdepbbclppomkhlknpii)
that polyfills the proposed Web standard, get a wallet (I went with
[GateHub](https://gatehub.net/), which works in US Dollars and Euros), and then
connect it to the extension.

You need to have funds in EUR (€) or USD ($). If you have crypto, it won't work,
which I've found out by trial and error, as I was part of
[Coil](https://coil.com/), the Web Monetization predecessor, which paid out in
XRP.

Just to clarify, while you need a wallet—that typically is used for crypto—the
actual transactions are all in real fiat money, Euro in my case.
...
![The Web Monetization extensions's popup window.](/images/web-monetization-extension.png)

You can adjust how much you want to pay the site per hour and also send one-time
payments. The money is "streamed" every minute, which you can observe in
DevTools.

![Chrome DevTools Network tab showing a POST request for a payment.](/images/web-monetization-post-request.png)

We actually have
[code in Chromium](https://groups.google.com/a/chromium.org/d/msgid/blink-dev/d91487a5-108c-46e7-accd-d44b734a0b34%40igalia.com)
to make native Web Monetization happen, implemented by Igalia and funded by the
Interledger Foundation. I hope they can share the experiment results soon.

## As a publisher

On your page, add a
[payment link](https://webmonetization.org/developers/link-element/). You get
...
Then you're ready to receive payments. Here's me browsing my blog and seeing
...
well. The 0.50 cents (not shown) was a successful one-time payment.

![The GateHub wallet showing incoming and outgoing transactions.](/images/web-monetization-wallet.png)

There's also a
[JavaScript API](https://webmonetization.org/developers/interfaces/), so you can
adjust the content of your page when your page notices that the user is paying.
...
![Chrome DevTools Console showing a `monetization` event.](/images/web-monetization-devtools.png)

This way you could, for example, remove ads, or unlock an article when you
notice a one-time payment. On my blog, I just show a "thank you" message for
now.

![Thank you message in the footer of my blog showing how much the user has paid.](/images/web-monetization-thank-you.png)

I'm really bulli$h on this proposed standard. Hopefully someone else will try it
