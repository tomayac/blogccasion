...
I'm very excited to share a guest post I wrote for the Hugging Face 🤗 blog! The
post is called
...
And Transformers.js aren't alone with experimenting with this, they're joined by
[WebLLM](https://webllm.mlc.ai/docs/user/advanced_usage.html#using-cross-origin-storage-cache)
(docs),
[wllama](https://github.com/ngxson/wllama/blob/master/src/storage/cos.ts)
(code),
[Flutter](https://github.com/flutter/flutter/blob/master/engine/src/flutter/lib/web_ui/flutter_js/src/instantiate_wasm.js)
(code), and
[Emscripten](https://emscripten.org/docs/compiling/CrossOriginStorage.html#crossoriginstorage)
(docs).
